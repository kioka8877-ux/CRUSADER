...
export const ControlPanel = ({ style, onChange }) => {
  ...
  return (
    <div>
      ...
      <Select label="Position" paramKey="subtitle_position" value={s.subtitle_position ?? "bottom"} options={["top", "center", "bottom"]} onChange={onChange} />
      <Select label="Alignement" paramKey="subtitle_align" value={s.subtitle_align ?? "center"} options={["left", "center", "right"]} onChange={onChange} />

      <SectionTitle>🏷️ Titres des worlds</SectionTitle>
      <Select label="Visible" paramKey="world_title_visible" value={s.world_title_visible ? "true" : "false"} options={["false", "true"]} onChange={(k, v) => onChange(k, v === "true")} />
      <Select label="Position" paramKey="world_title_position" value={s.world_title_position ?? "left"} options={["left", "right"]} onChange={onChange} />
      <Select label="Police" paramKey="world_title_font" value={s.world_title_font ?? s.font_primary ?? "Cinzel"} options={FONTS} onChange={onChange} />
      ...
      <Select label="Vignette" paramKey="vignette" value={s.vignette ? "true" : "false"} options={["false", "true"]} onChange={(k, v) => onChange(k, v === "true")} />
    </div>
  );
};
