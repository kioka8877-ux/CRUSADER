...
// node_modules/@remotion/gif/dist/esm/index.mjs
...
var QuickLRU = class {
  constructor(options) {
    ...
    __publicField(this, "onEviction");
    __publicField(this, "_size");
    __publicField(this, "cache");
    __publicField(this, "oldCache");
...
var manuallyManagedGifCache = /* @__PURE__ */ new Map();
...
var decompressFrame = (frame, gct) => {
  ...
  if ((_a = image.descriptor.lct) == null ? void 0 : _a.interlaced) {
  ...
  const resultImage = {
    ...
    colorTable: ((_b = image.descriptor.lct) == null ? void 0 : _b.exists) ? image.lct : gct,
    delay: (((_c = frame.gce) == null ? void 0 : _c.delay) || 10) * 10,
...
var parse2 = (src2, {
  signal,
  requestInit
}) => fetch(src2, { ...requestInit, signal }).then((resp) => {
  var _a;
  if (!((_a = resp.headers.get("Content-Type")) == null ? void 0 : _a.includes("image/gif")))
...
var normalizeRequestInit = (requestInit) => {
  ...
  return {
    ...rest,
    headers: headers ? Array.from(new Headers(headers).entries()) : void 0
  };
};
...
var useElementSize = (ref) => {
  ...
  const updateSize = (0, import_react4.useCallback)(() => {
    if (!ref.current) {
      return;
    }
...
var Canvas = (0, import_react3.forwardRef)(({
  index,
  frames,
  width,
  height,
  ...
  const [tempCtx] = (0, import_react3.useState)(() => {
    return makeCanvas();
  });
  const sourceCanvas = (0, import_react3.useMemo)(() => {
    if (typeof document === "undefined") {
      return null;
    }
    return document.createElement("canvas");
  }, []);
  const effectOutputCanvas = (0, import_react3.useMemo)(() => {
    if (typeof document === "undefined") {
      return null;
    }
    return document.createElement("canvas");
  ...
  const canvasCallbackRef = (0, import_react3.useCallback)((canvas) => {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    const outputCtx = outputCanvas == null ? void 0 : outputCanvas.getContext("2d");
  ...
  return (0, import_jsx_runtime.jsx)("canvas", {
    ...
    className,
    style,
    width: width ?? (size == null ? void 0 : size.width),
    height: height ?? (size == null ? void 0 : size.height)
  });
});
...
function useCurrentGifIndex({
  ...
  const duration = (0, import_react5.useMemo)(() => {
    if (delays.length !== 0) {
  ...
  const time = updatedFrame / videoConfig.fps * 1e3;
...
var GifForDevelopment = (0, import_react2.forwardRef)(({
  src: src2,
  width,
  height,
  onError,
  ...
  const resolvedSrc = resolveGifSource(src2);
  const requestInitRef = (0, import_react2.useRef)(requestInit);
  requestInitRef.current = requestInit;
  const cacheKey = getGifCacheKey({ resolvedSrc, requestInit });
  const [state, update] = (0, import_react2.useState)(() => {
  ...
  const currentOnLoad = (0, import_react2.useRef)(onLoad);
  const currentOnError = (0, import_react2.useRef)(onError);
  ...
  (0, import_react2.useEffect)(() => {
    ...
    prom.then((parsed) => {
      var _a;
      (_a = currentOnLoad.current) == null ? void 0 : _a.call(currentOnLoad, parsed);
      update(parsed);
      volatileGifCache.set(cacheKey, parsed);
      done = true;
    }).catch((err) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Canvas, {
    fit,
    index,
    frames: state.frames,
    width,
...
var GifForRendering = (0, import_react6.forwardRef)(({
  src: src2,
  width,
  height,
  onLoad,
  ...
  const resolvedSrc = resolveGifSource(src2);
  const requestInitRef = (0, import_react6.useRef)(requestInit);
  requestInitRef.current = requestInit;
  const cacheKey = getGifCacheKey({ resolvedSrc, requestInit });
  const { delayRender, continueRender } = useDelayRender();
  const [state, update] = (0, import_react6.useState)(() => {
  ...
  const [renderHandle] = (0, import_react6.useState)(() => delayRender(`Rendering <Gif/> with src="${resolvedSrc}"`, {
  ...
  const currentOnLoad = (0, import_react6.useRef)(onLoad);
  const currentOnError = (0, import_react6.useRef)(onError);
  currentOnLoad.current = onLoad;
  currentOnError.current = onError;
  (0, import_react6.useEffect)(() => {
  ...
  return (0, import_jsx_runtime3.jsx)(Canvas, {
    fit,
    index,
    frames: state.frames,
    width,
...
var GifInner = ({
  ...
  const refForOutline = import_react.default.useRef(null);
  ...
  const inner = env.isRendering ? (0, import_jsx_runtime4.jsx)(GifForRendering, {
    ...gifProps,
    ref
  }) : (0, import_jsx_runtime4.jsx)(GifForDevelopment, {
    ...gifProps,
    ref,
    refForOutline
  });
  return (0, import_jsx_runtime4.jsx)(Sequence, {
    layout: "none",
...
//# sourceMappingURL=@remotion_gif.js.map
