...
## DELTA — Production Validée (2026-07-15)
...
=======
**Composition** : `CrusaderDelta` (capsules WorldScene + announce-sync + sous-titres mot par mot)

**Mode par défaut** : `delta` dans tous les workflows GitHub Actions
>>>>>>> c0110f4 (DELTA: copy gamma/ from delta-test3 → delta/ on main — production validated)
...
=======
- Composition `CrusaderDelta` par défaut
- UI thumbnails (82 micro-previews)
- Auto-sync base64 (zéro aller-retour curation)

**Branche backup** : `delta-test3` conservée intacte
>>>>>>> c0110f4 (DELTA: copy gamma/ from delta-test3 → delta/ on main — production validated)
